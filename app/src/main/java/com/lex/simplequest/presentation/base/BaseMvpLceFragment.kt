...
abstract class BaseMvpLceFragment<U : BaseMvpLceContract.Ui, S : BaseMvpLceContract.Presenter.State, P : BaseMvpLceContract.Presenter<U, S>> :
    BaseMvpFragment<U, S, P>(), BaseMvpLceContract.Ui {
    ...
    protected fun isContentVisibleSafe(): Boolean =
        View.VISIBLE == layoutContent?.visibility
